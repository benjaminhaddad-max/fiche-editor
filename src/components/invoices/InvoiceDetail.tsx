...
export function InvoiceDetail({
  ...
  return (
    <Card className="overflow-hidden">
      <div className="flex flex-wrap items-start justify-between gap-6 border-b border-slate-200 p-6">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">
            Facture
          </p>
          <p className="mt-1 text-xl font-bold text-slate-900">{invoice.number}</p>
          <div className="mt-2">
        ...
        <dl className="text-sm">
          <div className="flex gap-3">
            <dt className="w-28 text-slate-500">Émise le</dt>
            <dd className="font-medium">{formatDate(invoice.issue_date)}</dd>
          </div>
          <div className="flex gap-3">
            <dt className="w-28 text-slate-500">Échéance</dt>
            <dd className="font-medium">{formatDate(invoice.due_date)}</dd>
          </div>
          <div className="flex gap-3">
            <dt className="w-28 text-slate-500">Période</dt>
      ...
      <div className="grid gap-6 border-b border-slate-200 p-6 sm:grid-cols-2">
        <div>
          ...
          <p className="font-semibold text-slate-900">{issuer.legal_name}</p>
