...
const wrap = (title, body, cta) => `<!doctype html><html lang="fr"><body style="margin:0;background:#f7f4ee;">
...
<h1 style="margin:8px 0 0;font-size:19px;color:#0e1e35;">${title}</h1></td></tr>
<tr><td style="padding:16px 28px;font-size:14px;line-height:1.65;color:#3b4c63;">${body}</td></tr>
